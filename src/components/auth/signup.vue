            ...
            <form @submit.prevent="onSubmit">
                <div class="input" :class="{invalid: $v.email.$error}">
                    ...
                    <input
                            ...
                            @blur="$v.email.$touch()"
                            v-model="email">
                    <p v-if="!$v.email.email">Please, provide provide a valid email address</p>
                </div>
                ...
                <div class="input" :class="{invalid: $v.password.$error}">
                    ...
                    <input
                            ...
                            v-model="password">
                    <p v-if="!$v.password.minLength">Password has to be at least {{ $v.password.$params.minLength.min }}
                        characters long</p>
                </div>
                <div class="input" :class="{invalid: $v.confirmPassword.$error}">
                    ...
                    <p v-if="!$v.confirmPassword.sameAs">Passwords must be same</p>
                </div>
                <div class="input" :class="{invalid: $v.country.$error}">
                    <label for="country">Country</label>
                    <select id="country" @select="$v.country.$touch()" v-model="country">
                ...
                <div class="hobbies">
                    ...
                    <p v-if="!$v.hobbyInputs.minLength">You have to specify at least {{
